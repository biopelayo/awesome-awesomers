...
\author{
    Pelayo Gonz\'{a}lez de Lena Rodr\'{\i}guez$^{1,2,\dagger}$
}
...
\newcommand{\affiliations}{%
    ...
    $^{2}$Laboratorio de Epigen\'{o}mica del C\'{a}ncer y Nanomedicina (EpiLab), ISPA-FINBA / CINN-CSIC, Oviedo, Espa\~{n}a\\[0.3cm]
...
\section*{Declaraci\'{o}n de uso de inteligencia artificial}

Este trabajo cont\'{o} con la asistencia de Claude (Anthropic) para el an\'{a}lisis de datos, la generaci\'{o}n de figuras, el c\'{o}mputo estad\'{\i}stico y la redacci\'{o}n del manuscrito. La IA fue utilizada como herramienta computacional bajo la direcci\'{o}n y supervisi\'{o}n del autor correspondiente. Todas las decisiones cient\'{\i}ficas, el dise\~{n}o de la investigaci\'{o}n, la interpretaci\'{o}n de datos y las conclusiones son responsabilidad exclusiva del autor humano. La IA no cumple los criterios ICMJE de autor\'{\i}a y, por tanto, no figura como autora. Se proporciona transparencia total sobre el uso de IA de acuerdo con las buenas pr\'{a}cticas emergentes para el uso responsable de IA en investigaci\'{o}n cient\'{\i}fica.
