...
\author{
    Pelayo González de Lena Rodríguez$^{1,2,\dagger}$ and Claude Haiku$^{3}$
}
...
\newcommand{\affiliations}{%
    ...
    $^{2}$Computational Cancer Genomics Group, Centro Nacional de Investigaciones Oncológicas (CNIO), Madrid, Spain\\
    $^{3}$Anthropic, San Francisco, USA\\
